...
public class Board extends JPanel implements ActionListener {
    ...
    private void doDrawing(Graphics g) {
        ...
        if (inGame) {
            ...
            System.out.println("Le score est "+score);
               if(score<10)
                 {
                     System.out.println("best luck next time  :D ");
                     balance =0;
                     code(balance);
                 }
                 if(score==10)
                 {
                     System.out.println("you've got a reduction for 100millimes :D ");
                     balance =100;
                     code(balance);
                 }
                 else if (score>10)
                 {
                     System.out.println("excelent work :DD ");
                     balance=200;
                     code(balance);
    ...
    private void code(int balance){
        
        try {
            Connection conn = connexion.getInstance().getCnx();
            String req = "INSERT INTO code_promo (balance) values (?) ";
